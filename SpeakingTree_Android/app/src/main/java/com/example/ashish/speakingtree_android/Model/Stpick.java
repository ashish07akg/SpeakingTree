...
public class Stpick implements Parcelable {
    ...
    public static final Creator<Stpick> CREATOR = new Creator<Stpick>() {
        @Override
        public Stpick createFromParcel(Parcel in) {
            return new Stpick(in);
        }

        @Override
        public Stpick[] newArray(int size) {
            return new Stpick[size];
        }
    };
